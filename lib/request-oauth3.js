...
function fetchDirectiveHelper(providerUri) {
  ...
  */
  ...
  return requestOauth3Json(providerUri + '/.well-known/oauth3.json').then(pass, function () {
    return requestOauth3Json(providerUri + '/oauth3.json').then(pass, function () {
...
module.exports.fetchDirectiveHelper = fetchDirectiveHelper;
