...
Oauth3Consumer._getOauthClient = function (self, req, providerUri, opts) {
  ...
  console.log('DEBUG _getOauthClient clientUri', opts.clientUri);
  if (opts.clientUri && !laxUriMatch(opts.clientUri, opts)) {
    err = new Error("");
...
Oauth3Consumer.authenticateHelper = function (self, req, providerUri, options) {
  ...
  return Oauth3Consumer._getOauthClient(self, req, providerUri, {
    clientId: req.query.client_id || req.query.clientId
  , clientUri: req.query.client_uri || req.query.clientUri
