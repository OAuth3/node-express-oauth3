...
module.exports.create = function (DirStore, KeyStore) {
  ...
  var TokenSigner = {
    ...
    signAsync: function (meta, params) {
      ...
      function parseAccountIds(profileRequest) {
        var requestAsync = PromiseA.promisify(require('request'));
        profileRequest = JSON.parse(JSON.stringify(profileRequest));
        // TODO read oauth3.json for format
        profileRequest.headers = { Authorization: 'Bearer ' + params.access_token };
        //profileRequest.headers = { Authorization: 'Token ' + params.access_token };

        //console.log('[DEBUG] parseAccountIds params');
        //console.log(params);
        return requestAsync(profileRequest).then(function (resp) {
          var json = resp.body;
          ...
          //console.log('token-signer parseAccountIds resp.body');
