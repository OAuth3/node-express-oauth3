...
, create: function (app, TokenSigner, ConfigStore, KeyValueStore, options) {
    options = options || {};
    ...
    var consumer = options.consumer || Oauth3.Consumer.create(TokenSigner, ConfigStore, KeyValueStore, options);
